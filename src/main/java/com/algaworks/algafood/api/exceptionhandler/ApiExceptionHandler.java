...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handlerPropertyBindingException(PropertyBindingException ex,
        ...
        String detail = String.format("Não é possível vincular a propriedade '%s'!", path);
    ...
    private ResponseEntity<Object> handleIgnoredPropertyException(IgnoredPropertyException ex,
        ...
        String detail = String.format("A propriedade '%s' é explicitamente ignorada!", path);
    ...
    public ResponseEntity<?> handleNegocioException(NegocioException ex, WebRequest request){
        ...
        return handleExceptionInternal(ex, problemType, new HttpHeaders(), status, request);
    }
